...
func NewsContent(news entity.News, categories []entity.Categories, activeCategory string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(fmt.Sprintf("() => $store.tabs.active = '%s'", news.Categories.Name)))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
