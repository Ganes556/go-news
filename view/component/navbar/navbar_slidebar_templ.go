...
func checkUrl(id string, page string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_checkUrl_d5de`,
		Function: `function __templ_checkUrl_d5de(id, page){const currentUrl = window.location.href;
	...
	if(pageParam === page) {
		...
		Call:       templ.SafeScript(`__templ_checkUrl_d5de`, id, page),
		CallInline: templ.SafeScriptInline(`__templ_checkUrl_d5de`, id, page),
	}
}
...
func Slidebar(param ParamNavbar) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/component/navbar/navbar_slidebar.templ`, Line: 91, Col: 54}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var2))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></a><ul class=\"dropdown-menu dropdown-menu-primary text-small shadow\"><li><a class=\"dropdown-item\" href=\"/user/profile\">Profile</a></li><li><hr class=\"dropdown-divider\"></li><li><a class=\"dropdown-item\" href=\"/user/logout\">Logout</a></li></ul></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
